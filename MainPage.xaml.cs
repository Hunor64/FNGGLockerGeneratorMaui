...
namespace FNGGLockerGeneratorMobile
{
    public partial class MainPage : ContentPage
    {
        ...
        public string LOCKER_URL = "";
        private async void btnLocker_Clicked(object sender, EventArgs e)
        {
            Uri uri = new Uri(LOCKER_URL);
            await Browser.Default.OpenAsync(uri, BrowserLaunchMode.SystemPreferred);
        }
